...
export function SignUpDialog() {
    ...
    return (
        <Grid item style={{ display: "flex", flexDirection: "column", backgroundColor: "#fefefe", alignItems: "center", borderRadius: "12px", marginTop: "5%", height: "450px", width: "400px" }}>
            <Typography variant='h3' color={"#181938"} sx={{ fontSize: '30px', marginTop: "5%" }} > Sign Up</Typography>
            <Grid
                spacing={2}
                style={{
                    display: "flex",
            ...
            >
                ...
                <TextField label="Email" variant="outlined" sx={{ marginTop: '1rem' }} />
            ...
            <NavLink to="/" style={{ textDecoration: 'none' }}>
                <Button variant="contained" color='secondary' sx={{ mt: "20%", ml: "1vw" }}>
                    <Typography variant='button' color="primary" sx={{ fontSize: '14px', fontWeight: "600" }} >Sign up</Typography>
                </Button>
            </NavLink>
        </Grid>
    )
